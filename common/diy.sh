...
wget -O target/linux/generic/hack-5.4/999-patch-5.4.61-rt37.patch https://raw.githubusercontent.com/QiuSimons/R2S-OpenWrt/master/PATCH/new/main/999-patch-5.4.61-rt37.patch
