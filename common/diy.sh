...
wget -P https://github.com/coolsnowwolf/lede/raw/master/target/linux/generic/hack-5.4/999-shortcut-fe-support.patch target/linux/generic/hack-5.4/999-shortcut-fe-support.patch
wget -P https://raw.githubusercontent.com/coolsnowwolf/lede/master/target/linux/generic/hack-5.4/999-thermal-tristate.patch target/linux/generic/hack-5.4/999-thermal-tristate.patch
