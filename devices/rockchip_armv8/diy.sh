...
sed -i 's/DEFAULT_PACKAGES +=/DEFAULT_PACKAGES += autocore-arm fdisk lsblk luci-app-cpufreq kmod-drm-rockchip kmod-gpu-lima kmod-usb2 kmod-usb3 -luci-app-gpsysupgrade -luci-app-attendedsysupgrade/' target/linux/rockchip/Makefile
