...
sed -i 's/shadowsocksr-libev-alt/shadowsocksr-libev-redir/g' package/*/*/*/Makefile
...
sed -i '/if test_proxy/i sleep 3600' package/*/*/luci-app-ssr-plus/root/usr/share/ssrplus/ssr-switch
