...
rm -Rf feeds/packages/net/{smartdns,mwan3,miniupnpd,aria2,https-dns-proxy,shadowsocks-libev,frpc,frps,openvpn} feeds/luci/applications/luci-app-{dockerman,smartdns,frpc,frps}
