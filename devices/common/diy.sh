...
echo -e "\q" | svn co https://github.com/coolsnowwolf/lede/trunk/target/linux/generic/pending-5.4 target/linux/generic/pending-5.4
...
find package/feeds/custom/*/ -maxdepth 1 -name "Makefile" ! -path "*rclone*" -name "Makefile" ! -path "*shadowsocksr-libev*" \
