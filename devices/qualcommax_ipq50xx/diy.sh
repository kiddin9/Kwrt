...
git_clone_path main https://github.com/coolsnowwolf/lede target/linux/qualcommax target/linux/generic package/boot package/firmware/ipq-wifi package/firmware/ath11k-firmware
