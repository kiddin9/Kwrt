...
cp -Rf ../diy/* ./
wget -P feeds/luci/ https://github.com/openwrt/luci/blob/openwrt-19.07/luci.mk -O luck.mk
...
wget -P package/network/config/firewall/patches/ https://github.com/coolsnowwolf/lede/raw/master/package/network/config/firewall/patches/fullconenat.patch -O fullconenat.patch
