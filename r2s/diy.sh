...
wget -O target/linux/rockchip/patches-5.4/105-char-add-support-for-rockchip-hardware-random-number.patch https://github.com/project-openwrt/openwrt/raw/master/target/linux/rockchip/patches-5.4/105-char-add-support-for-rockchip-hardware-random-number.patch
wget -O target/linux/rockchip/patches-5.4/106-arm64-dts-rockchip-add-hardware-random-number-genera.patch https://github.com/project-openwrt/openwrt/raw/master/target/linux/rockchip/patches-5.4/106-arm64-dts-rockchip-add-hardware-random-number-genera.patch
